...
export default function Catalogo() {
    ...
    const [carregandoProdutos, setCarregandoProdutos] = useState(false); // NOVO
    ...
    useEffect(() => {
        async function carregarProdutos() {
            if (!categoriaSelecionada) {
                setProdutos([]); // NOVO: limpa quando fecha a categoria
                return;
            }

            setProdutos([]);           // NOVO: limpa a lista antiga na hora
            setCarregandoProdutos(true); // NOVO: liga o loading
            ...
            try {
                ...
                setCarregandoProdutos(false); // NOVO: desliga sempre, mesmo com erro
            }
        }
    ...
    return (
        <section className="mt-6 px-1 py-2">
            ...
            <ListaCategoria
                ...
                produtos={produtos}
                carregando={carregandoProdutos} // NOVO
            />
